...
int find_min(void)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        {
            int min_num = candidates[i].votes;
            break;
        }
    }
    ...
    {
        if (candidates[j].votes < min_num && candidates[j].eliminated == false)
        {

        }
        else if (candidates[j].votes < min_num && candidates[j].eliminated == true)
        {
